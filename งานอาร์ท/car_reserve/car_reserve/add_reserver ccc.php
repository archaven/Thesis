...
?></span>
              <form id="form2" name="form2" method="post" action="save_reserver.php">
                <table width="800" border="0" cellpadding="5" cellspacing="1" class="square">
                  <tr>
                    <td colspan="4" align="right" bgcolor="#3E9EFF"><div align="center" class="style24">
                        <div align="left"><span class="style27">ขอบริการยานพาหนะ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style28">&nbsp;&nbsp;&nbsp;&nbsp;วันเวลาที่ขอ <? echo displaydate($thai2)?></span></div>
                    </div></td>
                  </tr>
                  
                  <tr>
                    <td align="right" bgcolor="#D6D6D6"><div align="center"><strong>สำนักงาน</strong></div></td>
                    <td width="16%" align="right" bgcolor="#FFCCFF"><div align="left">
                        <label>
                        <input name="office_reserver_car" type="radio" value="สำนักงานฟาร์ม" <? if ($rowA['office']=='สำนักงานฟาร์ม'){echo "checked";} ?> />
                        </label>
                      สำนักงานฟาร์ม
                      <label></label>
                      ่
                    ...
                    <td width="16%" align="right" bgcolor="#FF9933"><label>
                      <input name="office_reserver_car" type="radio" value="สำนักงานใหญ่" <? if ($rowA['office']=='สำนักงานใหญ่'){echo "checked";} ?> />
                    </label>
สำนักงานใหญ</td>
                    <td width="51%" align="right" bgcolor="#EBEBEB">&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="4" align="right" bgcolor="#EBEBEB"><div align="left"><strong>บริษัทที่ขอบริการ</strong><br />
                            <label>
                            <input name="company_reserver" type="radio" value="CDF" />
                  ...
                  <tr>
                    <td colspan="4" align="right" bgcolor="#FFFFFF"><label> </label>
                        <div align="left"><strong>ชื่อผู้ร่วมเดินทาง </strong><span class="style25">(กรุณาระบุคำนำหน้า นาย นาง หรือนางสาว) </span><br />
	   ...
	   for($i=1;$i<=12;$i++) { ?>
                  ...
                  <tr>
					...
					<? $nameA="$rowA[name] $rowA[lastname]";?>
                          <input type="text" name="id_name" value="<?=$nameA?>" readonly="readonly" />
                      &nbsp;</label>
                        <label><strong>ฝ่าย</strong>
		  ...
		  //include ("../checklevel.php");
		  		?>
                        <select name="section">
                          ...
                          <? for ($i=1;$i<=12;$i++) { ?>
                          <option value="<?=$section[$i]?>" <? if ($section[$i]==$rowA['section']){echo "selected";}?> >
                          <?=$section[$i]?>
                          </option>
                          <? } ?>
                        </select>
