...
?>
      ...
      <table width="1000" border="0" align="center" cellpadding="1" cellspacing="1" class="square">
        <tr>
          <td colspan="11" bgcolor="#FFCCFF"><span class="style36"><a href="show_reserver.php?id=<?=$id?>&amp;show="></a>| <a href="add_car.php?id=<?=$id?>">เพิ่มรถใหม่</a>| <a href="show_car.php?id=<?=$id?>">ปรับปรุงรายการรถ</a> | <a href="add_driver.php?id=<?=$id?>">เพิ่มพนักงานขับรถ</a>| <a href="show_driver.php?id=<?=$id?>">ปรับปรุงรายการพนักงาน</a> | <a href="show_reserver.php?id=<?=$id?>&amp;show=all">รายการขอบริการ</a></span></td>
        </tr>
		<?
		$show=$_GET['show'];		
		?>
        <tr>
          <td colspan="11" bgcolor="#BBDDFF"><span class="style64">รายการขอบริการ</span>
		<?
		 if($show!='all')
		 {    /////////////////////////////////////////////////////////////////////////
		 ?>
		  <span class="style66">[ วันที่
            <?
			     if($thai2=='--')
        ...
        <tr>
          ...
          <td width="100" bgcolor="#FFEBD7"><div align="center"><strong>สถานะ</strong></div></td>
          <td width="56" bgcolor="#FFEBD7"><div align="center"><strong>รับเรื่อง </strong></div></td>
...
if ($row['id_driver']==0){echo "--";}else{echo $rowQ[name_driver]; } ?>
          ...
          <td rowspan="2" bgcolor="<?=$bg?>"><div align="center">
              <?  if ($row['name_approve']!="การบริการเสร็จสิ้น") { ?>
          <a href="delete.php?id_reserver=<?=$row['id_reserver']?>&amp;id=<?=$id?>">[ลบ]</a><a href="end_report_reserver.php?id_reserver=<?=$row['id_reserver']?>"></a>
          <?
			  }
		  ?>
          </div></td>
